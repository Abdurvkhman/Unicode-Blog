    ...
    <div className="main">
      ...
      <div className="bootcamp">
        <div className="bootcamp-first-block">
          <h2 className="bootcamp-title">{categories?.[2].title}</h2>
          {posts?.map((bootcamp) => (
            <>
        ...
        <div className="bootcamp-second-block">
          ...
          <Link to={`/posts/category/:${posts?.[5]._id}`}>
            <img src={posts?.[5].image} alt="error" />
          </Link>
          <h2 className="bootcamp-second-block-second-title">
            {posts?.[5].title}
          </h2>
          <ReadMore len="200">{posts?.[5].text}</ReadMore>
          <hr />
          <Link to={`/posts/category/:${posts?.[1]._id}`}>
            <img src={posts?.[1].image} alt="error" />
          </Link>
          <h2 className="bootcamp-second-block-second-title">
            {posts?.[1].title}
          </h2>
          <ReadMore len="200">{posts?.[1].text}</ReadMore>
          <hr />
        </div>
      </div>
      <Recomendation />
...
export default ProjectOfStudents;
